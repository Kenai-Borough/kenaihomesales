...
export default function Layout() {
  ...
  return (
    <div className="min-h-screen bg-transparent text-slate-100">
      ...
      <AnimatePresence mode="wait"><motion.main id="main-content" key={location.pathname} initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -12 }} transition={{ duration: 0.22 }}><Outlet /></motion.main></AnimatePresence>

          <div className="mt-6 flex flex-wrap gap-x-4 gap-y-2 text-xs text-slate-400"><Link to="/terms" className="hover:text-white transition">Terms of Service</Link> | <Link to="/privacy" className="hover:text-white transition">Privacy Policy</Link> | <Link to="/cookies" className="hover:text-white transition">Cookie Policy</Link> | <Link to="/dmca" className="hover:text-white transition">DMCA</Link> | <Link to="/acceptable-use" className="hover:text-white transition">Acceptable Use</Link> | <Link to="/fair-housing" className="hover:text-white transition">Fair Housing</Link> | <Link to="/real-estate-disclaimer" className="hover:text-white transition">Real Estate Disclaimer</Link></div>
